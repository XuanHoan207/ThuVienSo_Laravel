...
@section('title', 'Thêm Sách Mới - Admin Thư Viện Số')
...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h3 mb-0">Thêm Sách Mới</h1>
            <p class="text-muted mb-0">Điền thông tin sách</p>
        </div>
                ...
                <div class="card border-0 shadow-sm mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <small class="text-muted">Để trống để tự động tạo từ tên sách</small>
                            @error('slug')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
            ...
            <div class="col-lg-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('published_year') is-invalid @enderror"
                                   ...
                                   value="{{ old('published_year', date('Y')) }}" min="1900" max="2100">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('language') is-invalid @enderror"
                                   id="language" name="language" value="{{ old('language', 'Vietnamese') }}">
                            @error('language')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('price_points') is-invalid @enderror"
                                   ...
                                   value="{{ old('price_points', 0) }}" min="0" required>
                            @error('price_points')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="card border-0 shadow-sm mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            <label for="file_path" class="form-label">File sách <span class="text-danger">*</span></label>
                            <input type="file" class="form-control @error('file_path') is-invalid @enderror"
                                   id="file_path" name="file_path" accept=".pdf,.epub" required>
                ...
                <button type="submit" class="btn btn-primary w-100">
                    <i class="bi bi-check-circle me-2"></i>Tạo sách mới
                </button>
            </div>
        </div>
    </form>
